...
var favs = {};
var favsObj = GM_getValue ("favsJson",  "");
if(favsObj){
    favs      = JSON.parse (favsObj);
}else{
    favs = '{' +
        '"lists": [' +
        '{' +
...
if(window.location.pathname.includes("favorites.php")) {
    ...
    if(current_fav > 9){
        if($("div p").text()=="No hits found" && (favs["lists"][current_fav-10]["galleries"].length-(current_page*25))>0){
            ...
            $("div p").after('<table class="ptt unl fav" style="margin:2px auto 0px"><tbody><tr><td class="ptdd">&lt;</td><td class="ptds"><a href="" onclick="return false">1</a></td><td class="ptdd">&gt;</td></tr></tbody></table>');
            ...
            if (favs["order"]=="posted") {
                ...
                option_3 = `<a class="order" href="#"rel="nofollow">Use Favorited</a>`;option_4 = `<span style="font-weight:bold">Posted</span>`;
...
var fav_options = "";
        ...
        var ret = GM_xmlhttpRequest({
            ...
            onload: function(res) {
                ...
                for (var j = (current_page*25); j < favs["lists"][current_fav-10]["galleries"].length; j++) {
                    if(display == "thumb"){
                        $(".itg").append(`<div class="id1" style="height:335px"><div class="id2"><a href="`+ current_domain + `/g/` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `/` + favs["lists"][current_fav-10]["galleries"][j]["gt"]+ `/">` + sadpandaInfo["gmetadata"][j-(current_page*25)]["title"] +`</a></div><div class="id3" style="height:280px"><a href="`+ current_domain + `/g/` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `/` + favs["lists"][current_fav-10]["galleries"][j]["gt"]+ `/"><img src="` + sadpandaInfo["gmetadata"][j-(current_page*25)]["thumb"] +`" alt="Free Hentai Doujinshi Gallery ` + sadpandaInfo["gmetadata"][j-(current_page*25)]["title"] + `" title="` + sadpandaInfo["gmetadata"][j-(current_page*25)]["title"] + `" style="position:relative; top:-3px"></a></div><div class="id4"><div class="id41" style="background-position:0 -35px" title="` + sadpandaInfo["gmetadata"][j-(current_page*25)]["category"] + `"></div><div class="id42">26 files</div><div class="id43 ir" style="background-position:-32px -1px; opacity:0.93333333333333; margin-top:2px"></div><div class="id44"><div style="float:right"><div onclick="return popUp('`+ current_domain + `/gallerypopups.php?gid=` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `&amp;t=` + favs["lists"][current_fav-10]["galleries"][j]["gt"]+ `&amp;act=addfav',675,415)" class="i" id="favicon_` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `" style="` + fav_icon + `; cursor:pointer; margin:5px 3px 0" title="` + favs["lists"][current_fav-10]["name"]+ `"></div><input type="checkbox" name="modifygids[]" value="` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `" style="position:relative; top:3px; left:-1px"></div></div></div></div>`);
                    }
                    if(display == "list"){
                        ...
                        $("tbody").eq(1).append(`<tr class="gtr`+color+` color`+color+`"><td class="itdc"><img src="` + image_domain + `/c/`+  sadpandaInfo["gmetadata"][j-(current_page*25)]["category"].toLowerCase().replace(" sets", "").replace(" ", "")+`.png" alt="` + sadpandaInfo["gmetadata"][j-(current_page*25)]["category"] + `" class="ic"></td><td class="itd" style="white-space:nowrap">` + timeConverter(sadpandaInfo["gmetadata"][j-(current_page*25)]["posted"]) + `</td><td class="itd"><div style="position:relative"><div class="it2" id="i` + sadpandaInfo["gmetadata"][j-(current_page*25)]["gid"] + `" style="border: 2px solid rgb(255, 0, 0); top: -52.5px; left: -216px; height: 101px; width: 200px; visibility: hidden;"><img src="` + sadpandaInfo["gmetadata"][j-(current_page*25)]["thumb"] + `" alt="` + sadpandaInfo["gmetadata"][j-(current_page*25)]["title"] +`" style="margin:0"></div><div class="it3"><div onclick="return popUp('` + current_domain + `/gallerypopups.php?gid=` + sadpandaInfo["gmetadata"][j-(current_page*25)]["gid"] + `&amp;t=` + sadpandaInfo["gmetadata"][j-(current_page*25)]["token"] +`&amp;act=addfav',675,415)" class="i" id="favicon_` + sadpandaInfo["gmetadata"][j-(current_page*25)]["gid"] + `" style="` + fav_icon + `; cursor:pointer" title="` + favs["lists"][current_fav-10]["name"] + `"></div><div class="i"><a href="https://exhentai.org/gallerytorrents.php?gid=` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `&amp;t=` + favs["lists"][current_fav-10]["galleries"][j]["gt"]+ `" onclick="return popUp('https://exhentai.org/gallerytorrents.php?gid=` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `&amp;t=` + favs["lists"][current_fav-10]["galleries"][j]["gt"]+ `', 610, 590)" rel="nofollow"><img src="`+image_domain+ `/t.png" class="n" alt="T" title="Torrents may exist for this gallery"></a></div></div><div class="it5"><a href="`+ current_domain + `/g/` + favs["lists"][current_fav-10]["galleries"][j]["gid"]+ `/` + favs["lists"][current_fav-10]["galleries"][j]["gt"]+ `" onmouseover="show_image_pane(` + favs["lists"][current_fav-10]["galleries"][j]["gid"] + `)" onmouseout="hide_image_pane(` + favs["lists"][current_fav-10]["galleries"][j]["gid"] + `)">` + sadpandaInfo["gmetadata"][j-(current_page*25)]["title"] + `</a></div><div class="it4"><div class="ir it4r" style="background-position:0px 0px; opacity:1"></div> </div></div><div style="font-style:italic; clear:both; padding:3px 0 1px 5px; display:none" id="favnote_` + sadpandaInfo["gmetadata"][j-(current_page*25)]["gid"] + `"></div></td><td class="itd" style="white-space:nowrap">` + year +`-`+monthIndex+`-`+day + ` ` + hour +`:` + minute +`</td><td style="text-align:center"><input class="inp unlfav" type="checkbox" " name="modifygids[]" value="` +  favs["lists"][current_fav-10]["galleries"][j]["gid"] + `"></td></tr>`);
                    }
                    if(j ==  (current_page*25)+24){
                        break;
                    }
